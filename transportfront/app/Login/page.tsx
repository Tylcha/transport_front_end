...
function Login() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setErrorMessage('Kullanici adi veya sifre hatali');
        }
    };
    return (
        <div>
                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit} action="#">
                                <div>
                                    ...
                                    <input type="text" name="tc" id="tc" value={user_name} onChange={(e) => setUser_name(e.target.value)} className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="kullanici adi" required />
                                </div>
                                <div>
                                    ...
                                    <label htmlFor="hata" className='block mb-2 mt-4 text-sm font-medium text-red-600 dark:text-white'>{errorMessage}</label>
                                </div>
                                ...
                                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                    Giris yapamiyorsaniz yoneticiyle iletisime gecin <a href="#" className="font-medium text-primary-600 hover:underline dark:text-primary-500">iletisim</a>
                                </p>
                            </form>
                        </div>
                    </div>
