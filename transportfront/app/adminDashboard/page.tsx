...
function Page() {
    const [userData, setUserData] = useState([]); // useState kullanımı
            ...
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg mt-32 container mx-auto">
                <div className="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-white dark:bg-gray-900">
                    ...
                    <div className="relative">
                        ...
                        <input type="text" id="table-search-users" onChange={handleChange} className="block p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for users" />
                    </div>
                </div>
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        {userData.map((user) =>(
                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" key={user.tc}>
                            ...
                            <th scope="row" className="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                ...
                                <div className="ps-3">
                                    <div className="text-base font-semibold">{user.tc}</div>
