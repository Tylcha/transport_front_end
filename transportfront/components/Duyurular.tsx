            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    <div className="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
                        <h2 className="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Duyurular</h2>
                        <p className="font-light text-gray-500 sm:text-xl dark:text-gray-400">Tum Duyurular burada goruntulerni</p>
                    </div>
                    ...
                    <div className="grid gap-8 lg:grid-cols-2">
                        <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a href="#">01.10.2024 Ders Bildirimi</a></h2>
                            <p className="mb-5 font-light text-gray-500 dark:text-gray-400">Is sagligi ve guvenligi hakkinda saaat 12 de konferans salonunda ders verilectir Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias voluptas quo aliquam harum repellat, pariatur aut rem culpa asperiores praesentium aspernatur ut ipsa earum id inventore accusantium exercitationem obcaecati illum?</p>
